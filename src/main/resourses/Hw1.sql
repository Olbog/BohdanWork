...
CREATE TABLE IF NOT EXISTS `mydb`.`Statuses` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `date_of_completion` INT NOT NULL,
  `responsible_for_the_order` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`Alcohol tests`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Alcohol tests` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `results` VARCHAR(45) NOT NULL,
  `drivers_id` INT NOT NULL,
  `replacement_driver_id` INT NOT NULL,
  PRIMARY KEY (`id`),
